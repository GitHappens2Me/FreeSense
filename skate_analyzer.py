...
Usage:
    python freeskate_analyzer.py <file>

Example: 
    python freeskate_analyzer.py ./Data/skate_data.csv
"""
import os
import sys
import numpy as np
...
class Visualizer:
    ...
    def plot_analysis_dashboard(self, save_path: Optional[str] = None):
        ...
        ax4.fill_between(t, y_min, y_max, where=rest_mask, alpha=0.2, color='gray')
        ...
        ax5.fill_between(t, y_min, y_max, where=rest_mask, alpha=0.2, color='gray')
        ...
        ax6.fill_between(t, y_min, y_max, where=rest_mask, alpha=0.2, color='gray')
...
def main():
    ...
    try:
        ...
        viz.plot_rest_detection("./Images/rest_detection.png")
        viz.plot_3d_trajectory("./Images/freeskate_3d.png")
        viz.plot_analysis_dashboard("./Images/freeskate_dashboard.png")
        ...
        output_df.to_csv("./Data/skate_data_processed.csv", index=False)
        print("\nSaved to ./Data/skate_data_processed.csv")
